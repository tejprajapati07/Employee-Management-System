...
<body>
    ...
    <h2>View All Managers</h2>

    <!-- Search Form -->
    <div class="search-container">
        <form action="/search" method="get">
            <input type="text" name="name" placeholder="Search Manager by Name" required>
        ...
        %>
            <tr>
                ...
                <td class="actions">
                    ...
                    <form action="/delete/<%= employee.getId() %>" method="post" onsubmit="return confirm('Are you sure you want to delete this manager?');">
